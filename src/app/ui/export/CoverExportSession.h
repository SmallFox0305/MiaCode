...
class CoverExportSession final : public QObject
{
    Q_OBJECT
...
public:
    CoverExportSession(miacode::ExportEngine& exportEngine,
...
private:
    ...
    miacode::ExportEngine& exportEngine_;
    miacode::UiRequestService* uiRequests_ = nullptr;
    miacode::PlaybackControl** playbackControlSlot_ = nullptr;
