...
private:
    ...
    void requestChartMediaImport(miacode::ChartMediaService::Kind kind);
    ...
    miacode::DocumentBridge** bridgeSlot_ = nullptr;
    miacode::DocumentBridge* bridge() const
    {
        return bridgeSlot_ != nullptr ? *bridgeSlot_ : nullptr;
    }
    miacode::ChartWorkspace* workspace_ = nullptr;
    miacode::ChartWorkspaceFileService* fileService_ = nullptr;
