...
const QHash<QString, QString>& enMap()
{
    static const QHash<QString, QString> map{
        ...
        {"action.transform.reset_tap_notes", "Reset to Single Tap"},
        {"shortcut.transform.reset_tap_notes", "Reset to Single Tap"},
        ...
        {"metadata.read_from_file", "Read from File"},
        {"metadata.choose_image_and_copy", "Choose a JPG, JPEG, or PNG and copy it into the chart folder as bg.*."},
        {"metadata.choose_video_and_copy", "Choose an MP4 and copy it into the chart folder as pv.mp4."},
        {"metadata.delete_pv", "Delete PV"},
        {"metadata.delete_pv_tooltip", "Delete the PV video from the chart folder."},
        {"metadata.delete_pv_confirm", "Delete the PV video from this chart? This cannot be undone."},
        {"metadata.no_pv_to_delete", "This chart has no PV video to delete."},
        {"metadata.delete_pv_failed", "Could not delete these PV files:\n%1"},
        {"metadata.deleted_pv", "PV deleted."},
        ...
        {"metadata.invalid_property", "Invalid property: use &key=value."},
        {"metadata.invalid_property_lines", "invalid property (line %1)"},
        {"metadata.invalid_property_status", "Invalid property on line %1. Use &key=value."},
        {"metadata.needs_attention", "%1\nNeeds attention: %2"},
        {"metadata.invalid_property", "Invalid property: use &key=value."},
        {"metadata.invalid_property_lines", "invalid property (line %1)"},
        {"metadata.invalid_property_status", "Invalid property on line %1. Use &key=value."},
        {"metadata.needs_attention", "%1\nNeeds attention: %2"},
        ...
        {"dialog.preferences.background.opacity", "Image opacity"},
        {"dialog.preferences.background.opacity_hint", "Higher values make the image more visible. Each area also has a cover opacity setting."},
        {"dialog.preferences.background.overlay", "Area cover opacity"},
        {"dialog.preferences.background.overlay_hint", "Higher values cover more of the image and improve text readability. 0% shows the image; 100% covers it."},
        ...
        {"dialog.video_export.range.play_clip", "Play Export Clip"},
        {"dialog.video_export.range.stop_clip", "Stop Export Clip"},
        ...
        {"document.selection_beats_single", "Selection: %1 beats"},
        {"document.selection_beats_mixed", "Selection: %1 commas"},
        {"document.selection_beats_mixed_tooltip", "%1 beats"},
        ...
        {"latency.fine_decrease_1", "Fine decrease %1"},
        {"latency.fine_increase_1", "Fine increase %1"},
        ...
        {"net.cancel_connection_test", "Cancel Test"},
        {"net.canceling", "Canceling..."},
        {"net.canceled", "Canceled"},
        {"net.chart_complete_1_2", "Chart complete: %1 -> %2"},
        {"net.chart_failed_1_2", "Chart failed: %1 — %2"},
        ...
        {"net.connection_blocked", "Blocked by Net/Cloudflare"},
        {"net.connection_failed", "Connection failed"},
        {"net.connection_normal_1_ms", "Connection normal · %1 ms"},
        {"net.connection_not_tested", "Not tested"},
        {"net.connection_slow_1_ms", "Slow response · %1 ms"},
        {"net.connection_test_canceled", "Connection test canceled"},
        {"net.connection_test_result_1_http_2_ms_3_4", "Connection test: %1, HTTP=%2, elapsed=%3ms, detail=%4"},
        {"net.connection_test_started", "Testing the Majdata connection."},
        {"net.connection_timeout", "Connection timed out"},
        {"net.could_not_create_chart_folder", "Could not create chart folder."},
        {"net.designer", "Designer"},
        {"net.done_folder", "Done"},
        {"net.done_folder_zip", "Done"},
        ...
        {"net.online_preview", "Online Preview"},
        {"net.online_preview_cache_failed", "Could not create the online-preview session cache."},
        {"net.online_preview_failed", "Online preview resources could not be loaded."},
        {"net.online_preview_loading", "Loading preview"},
        {"net.online_preview_loading_1", "Loading online preview: %1"},
        {"net.online_preview_open_failed", "The cached online chart could not be opened."},
        {"net.online_preview_opened", "Online preview opened."},
        {"net.optional_resource_not_available_1", "Optional resource is not available: %1"},
        {"net.output_directory", "Output Directory"},
        {"net.package_failed_1", "Package failed: %1"},
        {"net.packaging_zip", "Packaging"},
        {"net.paused", "Paused"},
        {"net.pending", "Pending"},
        ...
        {"net.query", "Query"},
        {"net.query_and_download_diagnostics_will", "Connection, query, and download diagnostics will appear here."},
        ...
        {"net.sort_by", "Sort"},
        {"net.sort_level_ascending", "Level: low to high"},
        {"net.sort_level_descending", "Level: high to low"},
        {"net.sort_status_ascending", "Download status: ascending"},
        {"net.sort_status_descending", "Download status: descending"},
        {"net.sort_uploaded_newest", "Upload time: newest first"},
        {"net.sort_uploaded_oldest", "Upload time: oldest first"},
        {"net.start", "Start"},
        {"net.start_chart_1_2", "Start chart: %1 [%2]"},
        {"net.start_download_queue_selected_1", "Start download queue: selected=%1, output=%2, extra ZIP=%3, download PV=%4"},
        {"net.start_query_user_1_tag", "Start query: user=%1, tag=%2, title=%3, dates=%4..%5, fuzzy case=%6"},
        {"net.status", "Status"},
        {"net.test_connection", "Test Connection"},
        {"net.testing_connection", "Testing..."},
        {"net.title", "Title"},
        ...
        {"preferences.scroll_beyond_last_line", "Scroll Beyond Last Line"},
        {"preferences.scroll_beyond_last_line_hint", "Adds virtual space below the file so its final line can be scrolled toward the top of the editor."},
        {"preferences.editor_selection_beat_display", "Show selection beat count"},
        {"preferences.editor_selection_beat_display_hint", "When text is selected, show its comma count and beat subdivision in the editor header."},
        {"preferences.prevent_multi_click_selection", "Repeated clicks do not select a region"},
        {"preferences.prevent_multi_click_selection_hint", "Double-clicking or repeatedly clicking moves the caret without automatically selecting a word or paragraph. Drag selection is unaffected."},
        ...
        {"validation.difficulty_level_missing", "[ERROR] Missing difficulty level"},
        ...
        {"video_export.export_range_from_selection", "Export Selected Range"},
        {"video_export.export_selection_invalid", "The selected chart objects do not form a valid export range."},
        {"video_export.export_selection_changed", "The chart changed before the selected range could be opened."},
        ...
        {"track_metadata.background_image_exists_overwrite", "The chart already contains a background image. Replace it? The existing file will be kept as a backup copy."},
        {"track_metadata.background_video_exists_overwrite", "The chart already contains a background video. Replace it? The existing file will be kept as a backup copy."},
        {"track_metadata.copying_background_image", "Copying background image..."},
        {"track_metadata.copying_background_video", "Copying background video..."},
        {"track_metadata.extract_cover_to_bg_jpg", "Extract Cover to bg.jpg"},
        {"track_metadata.failed_to_import_media", "Failed to import the media file.\n\nDetails: %1"},
        {"track_metadata.failed_to_read_image", "The selected file could not be read as an image."},
        ...
        {"track_metadata.import_background_image", "Import Background Image"},
        {"track_metadata.import_background_video", "Import Background Video"},
        {"track_metadata.imported_background_image", "Imported background image to %1."},
        {"track_metadata.imported_background_video", "Imported background video to %1."},
        {"track_metadata.imported_with_cleanup_warning", "The new media was imported, but backup copies could not be preserved for these files:\n%1"},
        ...
        {"track_metadata.unsupported_media_file", "The selected file type is not supported."},
        ...
        {"media_tools.compress_1_under_20_mib", "Compress %1 under 20 MB and create/replace backup %2? The video audio track will be removed."},
        {"media_tools.compress_the_background_video_under", "Compress to under 20 MB."},
        {"media_tools.compress_video", "Compress Video"},
        {"media_tools.compressed_1_under_20_mib", "Compressed %1 under 20 MB."},
        {"media_tools.compressed_1_under_20_mib_2", "Compressed %1 under 20 MB (original backed up as %2)."},
        {"media_tools.compressing_video", "Compressing video..."},
        {"media_tools.convert_track_mp3_to_44100", "Convert %1 to 44100 Hz and create/replace backup %2?"},
        {"media_tools.converted_track_mp3_to_44100", "Converted %1 to 44100 Hz."},
        {"media_tools.converted_track_mp3_to_44100_2", "Converted %1 to 44100 Hz (original backed up as %2)."},
        ...
        {"media_tools.insert_a_black_screen_at", "Add a black screen at the start."},
        {"media_tools.insert_silence_at_the_start", "Add silence at the start."},
        ...
        {"media_tools.processing_track_mp3", "Processing %1..."},
        {"media_tools.restore_backup", "Restore Backup"},
        {"media_tools.sample_rate", "Sample Rate"},
        {"media_tools.sample_rate_description", "Convert to 44100 Hz and keep the format."},
        ...
        {"media_tools.supported_track_audio", "supported track audio (track.mp3/track.wav/track.flac/track.ogg)"},
        {"media_tools.track_mp3_failed", "%1 processing failed"},
        {"media_tools.track_mp3_processing_canceled", "%1 processing canceled."},
        {"media_tools.track_mp3_was_not_found", "No supported track audio was found next to the current chart (track.mp3/track.wav/track.flac/track.ogg)."},
        ...
        {"net.upload_log_open_failed_1", "Cannot write the upload log: %1"},
        {"net.upload_log_saved_1", "Upload log: %1"},
        ...
        {"media_tools.batch_pv_description", "Scan the selected folder and its immediate subfolders for bg.mp4 or pv.mp4, then compress videos under 20 MB while preserving frame rate and removing audio."},
        ...
        {"media_tools.batch_pv_output_invalid", "Output was not smaller than the original and strictly under 20 MB."},
...
const QHash<QString, QString>& zhMap()
{
    static const QHash<QString, QString> map{
        ...
        {"action.transform.reset_tap_notes", "重置摆键"},
        ...
        {"metadata.field.background_video", "PV"},
        {"metadata.read_from_file", "从文件中读取"},
        {"metadata.choose_image_and_copy", "选择 JPG、JPEG 或 PNG 图片，并以 bg.* 名称复制到当前谱面目录。"},
        {"metadata.choose_video_and_copy", "选择 MP4 视频，并以 pv.mp4 名称复制到当前谱面目录。"},
        {"metadata.delete_pv", "删除 PV"},
        {"metadata.delete_pv_tooltip", "删除当前谱面目录中的 PV 视频。"},
        {"metadata.delete_pv_confirm", "确定删除当前谱面的 PV 视频吗？此操作无法撤销。"},
        {"metadata.no_pv_to_delete", "当前谱面没有可删除的 PV 视频。"},
        {"metadata.delete_pv_failed", "以下 PV 文件删除失败：\n%1"},
        {"metadata.deleted_pv", "PV 已删除。"},
        ...
        {"metadata.invalid_property", "属性写法非法：请使用 &属性名=值。"},
        {"metadata.invalid_property_lines", "非法属性（第 %1 行）"},
        {"metadata.invalid_property_status", "第 %1 行属性写法非法，请使用 &属性名=值。"},
        {"metadata.needs_attention", "%1\n需要检查：%2"},
        {"metadata.invalid_property", "属性写法非法：请使用 &属性名=值。"},
        {"metadata.invalid_property_lines", "非法属性（第 %1 行）"},
        {"metadata.invalid_property_status", "第 %1 行属性写法非法，请使用 &属性名=值。"},
        ...
        {"dialog.preferences.background.opacity", "图片不透明度"},
        {"dialog.preferences.background.opacity_hint", "数值越大，图片越明显。各区域的遮罩强度也会影响最终效果。"},
        {"dialog.preferences.background.overlay", "区域遮罩强度"},
        {"dialog.preferences.background.overlay_hint", "数值越大，图片遮挡越多，文字越易读。 0% 显示图片，100% 完全遮挡。"},
        {"dialog.preferences.background.overlay_button", "调整区域遮罩..."},
        {"dialog.preferences.background.overlay_dialog_title", "区域遮罩强度"},
        ...
        {"dialog.video_export.range.play_clip", "播放导出片段"},
        {"dialog.video_export.range.stop_clip", "停止播放"},
        ...
        {"document.selection_beats_single", "选中 %1 拍"},
        {"document.selection_beats_mixed", "选中 %1 个逗号"},
        {"document.selection_beats_mixed_tooltip", "%1 拍"},
        ...
        {"latency.fine_decrease_1", "微调减少 %1"},
        {"latency.fine_increase_1", "微调增加 %1"},
        {"latency.offset", "偏移"},
        ...
        {"net.cancel_connection_test", "取消测试"},
        {"net.canceling", "正在取消..."},
        {"net.canceled", "已取消"},
        {"net.chart_complete_1_2", "谱面完成：%1 -> %2"},
        {"net.chart_failed_1_2", "谱面失败：%1 — %2"},
        ...
        {"net.connection_blocked", "Net/Cloudflare 已阻断连接"},
        {"net.connection_failed", "连接失败"},
        {"net.connection_normal_1_ms", "连接正常 · %1 ms"},
        {"net.connection_not_tested", "未测试"},
        {"net.connection_slow_1_ms", "响应较慢 · %1 ms"},
        {"net.connection_test_canceled", "连接测试已取消"},
        {"net.connection_test_result_1_http_2_ms_3_4", "连接测试：%1，HTTP=%2，耗时=%3ms，详情=%4"},
        {"net.connection_test_started", "开始测试 Majdata 连接。"},
        {"net.connection_timeout", "连接超时"},
        {"net.could_not_create_chart_folder", "无法创建谱面文件夹。"},
        {"net.designer", "谱师"},
        {"net.done_folder", "完成"},
        {"net.done_folder_zip", "完成"},
        ...
        {"net.online_preview", "在线预览"},
        {"net.online_preview_cache_failed", "无法创建在线预览会话缓存。"},
        {"net.online_preview_failed", "在线预览资源加载失败。"},
        {"net.online_preview_loading", "加载预览中"},
        {"net.online_preview_loading_1", "正在加载在线预览：%1"},
        {"net.online_preview_open_failed", "无法打开已缓存的在线谱面。"},
        {"net.online_preview_opened", "已打开在线预览。"},
        {"net.optional_resource_not_available_1", "可选资源不可用：%1"},
        {"net.output_directory", "输出目录"},
        {"net.package_failed_1", "打包失败：%1"},
        {"net.packaging_zip", "打包中"},
        {"net.paused", "已暂停"},
        {"net.pending", "待下载"},
        {"net.please_choose_a_valid_output", "请选择有效的输出目录。"},
        {"net.please_enter_a_user_id", "请输入用户 ID、Tag 或歌曲名。"},
        {"net.query", "查询"},
        {"net.query_and_download_diagnostics_will", "连接、查询和下载诊断日志会显示在这里。"},
        ...
        {"net.song_title", "歌曲名"},
        {"net.sort_by", "排序"},
        {"net.sort_level_ascending", "等级：从低到高"},
        {"net.sort_level_descending", "等级：从高到低"},
        {"net.sort_status_ascending", "下载状况：升序"},
        {"net.sort_status_descending", "下载状况：降序"},
        {"net.sort_uploaded_newest", "上传时间：最新优先"},
        {"net.sort_uploaded_oldest", "上传时间：最早优先"},
        {"net.start", "开始"},
        {"net.start_chart_1_2", "开始谱面：%1 [%2]"},
        {"net.start_download_queue_selected_1", "开始下载队列：选中 %1，输出 %2，额外 ZIP=%3，下载 PV=%4"},
        {"net.start_query_user_1_tag", "开始查询：用户=%1，tag=%2，歌曲名=%3，日期=%4..%5，模糊大小写=%6"},
        {"net.status", "状态"},
        {"net.test_connection", "测试连接"},
        {"net.testing_connection", "正在测试..."},
        {"net.title", "标题"},
        {"net.uploaded", "上传时间"},
        {"net.user_id", "用户 ID"},
        ...
        {"preferences.scroll_beyond_last_line", "滚动超过最后一行"},
        {"preferences.scroll_beyond_last_line_hint", "在文件末尾下方添加虚拟空白，使最后一行可以滚动到编辑器上方。"},
        {"preferences.editor_selection_beat_display", "显示选区拍数"},
        {"preferences.editor_selection_beat_display_hint", "选中文本时，在编辑器标题处显示逗号数量和分音信息。"},
        {"preferences.prevent_multi_click_selection", "连续点击不选中区域"},
        {"preferences.prevent_multi_click_selection_hint", "双击或连续点击时只移动光标，不自动选择单词或段落；拖动选择不受影响。"},
        ...
        {"validation.difficulty_level_missing", "[错误] 未填写难度"},
        {"validation.difficulty_level_missing_type", "未填写难度"},
        ...
        {"video_export.export_range_from_selection", "区间导出"},
        {"video_export.export_selection_invalid", "所选谱面物件无法形成有效的导出区间。"},
        {"video_export.export_selection_changed", "选区导出打开前谱面内容已发生变化，请重新选择。"},
        ...
        {"track_metadata.background_video_exists_overwrite", "当前谱面已经包含背景视频，是否替换？原文件将保留为备份副本。"},
        {"track_metadata.copying_background_image", "正在复制曲绘……"},
        {"track_metadata.copying_background_video", "正在复制背景视频……"},
        {"track_metadata.extract_cover_to_bg_jpg", "提取封面为 bg.jpg"},
        {"track_metadata.failed_to_import_media", "导入媒体文件失败。\n\n详细信息：%1"},
        {"track_metadata.failed_to_read_image", "无法将所选文件读取为图片。"},
        ...
        {"track_metadata.import_background_video", "导入背景视频"},
        {"track_metadata.imported_background_image", "已将曲绘导入到 %1。"},
        {"track_metadata.imported_background_video", "已将背景视频导入到 %1。"},
        {"track_metadata.imported_with_cleanup_warning", "新媒体已导入，但无法为以下文件保留备份副本：\n%1"},
        ...
        {"track_metadata.unsupported_media_file", "不支持所选文件的格式。"},
        ...
        {"media_tools.compress_1_under_20_mib", "将压缩 %1 到 20 MB 内、移除视频音轨，并生成/覆盖备份 %2。是否继续？"},
        {"media_tools.compress_the_background_video_under", "压缩至 20 MB 以内。"},
        {"media_tools.compress_video", "视频压缩"},
        {"media_tools.compressed_1_under_20_mib", "已压缩 %1 到 20 MB 内。"},
        {"media_tools.compressed_1_under_20_mib_2", "已压缩 %1 到 20 MB 内（原文件已备份为 %2）。"},
        {"media_tools.compressing_video", "正在压缩视频..."},
        {"media_tools.convert_track_mp3_to_44100", "将 %1 处理为 44100Hz，并生成/覆盖备份 %2。是否继续？"},
        {"media_tools.converted_track_mp3_to_44100", "已将 %1 处理为 44100Hz。"},
        {"media_tools.converted_track_mp3_to_44100_2", "已将 %1 处理为 44100Hz（原文件已备份为 %2）。"},
        ...
        {"media_tools.insert_a_black_screen_at", "在视频开头添加黑幕。"},
        {"media_tools.insert_silence_at_the_start", "在音频开头添加静音。"},
        ...
        {"media_tools.processing_track_mp3", "正在处理 %1..."},
        {"media_tools.restore_backup", "还原备份"},
        {"media_tools.sample_rate", "采样率转换"},
        {"media_tools.sample_rate_description", "转换为 44100 Hz，保留原格式。"},
        ...
        {"media_tools.supported_track_audio", "支持的音频（track.mp3/track.wav/track.flac/track.ogg）"},
        {"media_tools.track_mp3_failed", "%1 处理失败"},
        {"media_tools.track_mp3_processing_canceled", "已取消 %1 处理。"},
        {"media_tools.track_mp3_was_not_found", "当前谱面目录缺少支持的音频（track.mp3/track.wav/track.flac/track.ogg）。"},
        ...
        {"net.upload_log_open_failed_1", "无法写入上传日志：%1"},
        {"net.upload_log_saved_1", "上传日志：%1"},
        ...
        {"media_tools.batch_pv_description", "扫描所选文件夹及其直接子文件夹中的 bg.mp4 或 pv.mp4，保持原帧率、移除音轨，并将视频压缩到 20 MB 以内。"},
        ...
        {"media_tools.batch_pv_output_invalid", "输出未同时满足小于原文件且严格小于 20 MB。"},
...
const QHash<QString, QString>& jaMap()
{
    static const QHash<QString, QString> map{
        ...
        {"action.transform.reset_tap_notes", "単一タップにリセット"},
        {"shortcut.transform.reset_tap_notes", "単一タップにリセット"},
        ...
        {"metadata.field.background_video", "PV"},
        {"metadata.read_from_file", "ファイルから読み込む"},
        {"metadata.choose_image_and_copy", "JPG、JPEG、または PNG を選び、bg.* として譜面フォルダーにコピーします。"},
        {"metadata.choose_video_and_copy", "MP4 を選び、pv.mp4 として譜面フォルダーにコピーします。"},
        {"metadata.delete_pv", "PV を削除"},
        {"metadata.delete_pv_tooltip", "譜面フォルダーから PV 動画を削除します。"},
        {"metadata.delete_pv_confirm", "この譜面の PV 動画を削除しますか？この操作は元に戻せません。"},
        {"metadata.no_pv_to_delete", "この譜面には削除できる PV 動画がありません。"},
        {"metadata.delete_pv_failed", "次の PV ファイルを削除できませんでした：\n%1"},
        {"metadata.deleted_pv", "PV を削除しました。"},
        ...
        {"metadata.invalid_property", "属性の形式が不正です。&key=value を使用してください。"},
        {"metadata.invalid_property_lines", "不正な属性（%1 行目）"},
        {"metadata.invalid_property_status", "%1 行目の属性形式が不正です。&key=value を使用してください。"},
        {"metadata.needs_attention", "%1\n要確認：%2"},
        {"metadata.invalid_property", "属性の形式が不正です。&key=value を使用してください。"},
        {"metadata.invalid_property_lines", "不正な属性（%1 行目）"},
        {"metadata.invalid_property_status", "%1 行目の属性形式が不正です。&key=value を使用してください。"},
        ...
        {"dialog.preferences.background.opacity", "画像の不透明度"},
        {"dialog.preferences.background.opacity_hint", "値を上げると画像が鮮明になります。各領域のカバー不透明度も表示に影響します。"},
        {"dialog.preferences.background.overlay", "領域のカバー不透明度"},
        {"dialog.preferences.background.overlay_hint", "値を上げると画像が隠れ、文字が読みやすくなります。 0% で画像を表示し、100% で完全に隠します。"},
        ...
        {"dialog.video_export.range.play_clip", "出力範囲を再生"},
        {"dialog.video_export.range.stop_clip", "再生を停止"},
        {"dialog.video_export.preview.stop", "停止"},
        ...
        {"document.selection_beats_single", "選択範囲 %1 拍"},
        {"document.selection_beats_mixed", "選択範囲 %1 個のコンマ"},
        {"document.selection_beats_mixed_tooltip", "%1 拍"},
        ...
        {"latency.fine_decrease_1", "%1 ずつ微調整して減らす"},
        {"latency.fine_increase_1", "%1 ずつ微調整して増やす"},
        ...
        {"net.browse", "参照..."},
        {"net.cancel_download", "Cancel Download"},
        {"net.cancel_connection_test", "テストをキャンセル"},
        {"net.canceling", "Canceling..."},
        {"net.canceled", "キャンセル済み"},
        {"net.chart_complete_1_2", "Chart complete: %1 -> %2"},
        {"net.chart_failed_1_2", "チャート失敗：%1 — %2"},
        {"net.chart_speed_summary_1_total", "Chart speed summary: %1 total=%2 bytes network=%3ms avg=%4 slowest=%5/%6ms"},
        {"net.choose_output_directory", "Choose Output Directory"},
        {"net.clear_selection", "Clear Selection"},
        {"net.connection_blocked", "Net/Cloudflare によってブロックされました"},
        {"net.connection_failed", "接続失敗"},
        {"net.connection_normal_1_ms", "接続正常 · %1 ms"},
        {"net.connection_not_tested", "未テスト"},
        {"net.connection_slow_1_ms", "応答が遅い · %1 ms"},
        {"net.connection_test_canceled", "接続テストをキャンセルしました"},
        {"net.connection_test_result_1_http_2_ms_3_4", "接続テスト：%1、HTTP=%2、経過=%3ms、詳細=%4"},
        {"net.connection_test_started", "Majdata への接続をテストしています。"},
        {"net.connection_timeout", "接続がタイムアウトしました"},
        {"net.could_not_create_chart_folder", "Could not create chart folder."},
        {"net.designer", "譜面作者"},
        {"net.done_folder", "完了"},
        {"net.done_folder_zip", "完了"},
        {"net.download_canceled", "Download canceled."},
        {"net.download_complete_1_succeeded_2", "Download complete: %1 succeeded, %2 failed."},
        {"net.download_complete_with_errors_1", "%1 chart(s) could not be downloaded completely. Incomplete files were not saved. Please check the download log for details."},
        {"net.download_resource_chart_1_resource", "Download resource: chart=%1 resource=%2 attempt=%3"},
        {"net.download_selected", "Download Selected"},
        {"net.download_pv", "PV をダウンロード"},
        {"net.downloading", "ダウンロード中"},
        {"net.downloading_1", "Downloading: %1"},
        {"net.downloading_1_2", "Downloading: %1"},
        {"net.end", "End"},
        {"net.enter_a_user_id_or", "Enter a user ID or tag, choose a date range, then query."},
        ...
        {"net.no_charts_are_selected", "No charts are selected."},
        {"net.not_selected", "Not selected"},
        {"net.online_preview", "オンラインプレビュー"},
        {"net.online_preview_cache_failed", "オンラインプレビュー用のセッションキャッシュを作成できません。"},
        {"net.online_preview_failed", "オンラインプレビューのリソースを読み込めませんでした。"},
        {"net.online_preview_loading", "プレビュー読込中"},
        {"net.online_preview_loading_1", "オンラインプレビューを読み込み中：%1"},
        {"net.online_preview_open_failed", "キャッシュしたオンライン譜面を開けませんでした。"},
        {"net.online_preview_opened", "オンラインプレビューを開きました。"},
        {"net.optional_resource_not_available_1", "オプションリソースを利用できません：%1"},
        {"net.output_directory", "Output Directory"},
        {"net.package_failed_1", "Package failed: %1"},
        {"net.packaging_zip", "圧縮中"},
        {"net.paused", "Paused"},
        {"net.pending", "Pending"},
        {"net.please_choose_a_valid_output", "Please choose a valid output directory."},
        {"net.please_enter_a_user_id", "Please enter a user ID, tag, or song title."},
        {"net.query", "Query"},
        {"net.query_and_download_diagnostics_will", "接続・検索・ダウンロードの診断ログがここに表示されます。"},
        {"net.query_complete_1_ms_api", "Query complete (%1 ms): API returned %2, date filter kept %3, local ID/tag/title filter kept %4."},
        {"net.query_failed", "Query failed."},
        {"net.query_failed_1_ms_2", "Query failed (%1 ms): %2"},
        {"net.querying_net", "Querying Net..."},
        ...
        {"net.song_title", "Song Title"},
        {"net.sort_by", "並べ替え"},
        {"net.sort_level_ascending", "レベル：低い順"},
        {"net.sort_level_descending", "レベル：高い順"},
        {"net.sort_status_ascending", "ダウンロード状況：昇順"},
        {"net.sort_status_descending", "ダウンロード状況：降順"},
        {"net.sort_uploaded_newest", "アップロード日時：新しい順"},
        {"net.sort_uploaded_oldest", "アップロード日時：古い順"},
        {"net.start", "Start"},
        {"net.start_chart_1_2", "Start chart: %1 [%2]"},
        {"net.start_download_queue_selected_1", "Start download queue: selected=%1, output=%2, extra ZIP=%3, download PV=%4"},
        {"net.start_query_user_1_tag", "Start query: user=%1, tag=%2, title=%3, dates=%4..%5, fuzzy case=%6"},
        {"net.status", "Status"},
        {"net.test_connection", "接続テスト"},
        {"net.testing_connection", "テスト中..."},
        {"net.title", "タイトル"},
        {"net.uploaded", "Uploaded"},
        {"net.user_id", "User ID"},
        {"net.zip_package_1_2_3", "ZIP package: %1 -> %2 (%3 ms)"},
        ...
        {"preferences.scroll_beyond_last_line", "最終行を越えてスクロール"},
        {"preferences.scroll_beyond_last_line_hint", "ファイル末尾の下に仮想余白を追加し、最終行をエディター上部までスクロールできるようにします。"},
        {"preferences.editor_selection_beat_display", "選択範囲の拍数を表示"},
        {"preferences.editor_selection_beat_display_hint", "テキストを選択すると、エディター上部にコンマ数と分音情報を表示します。"},
        {"preferences.prevent_multi_click_selection", "連続クリックで範囲選択しない"},
        {"preferences.prevent_multi_click_selection_hint", "ダブルクリックや連続クリックではキャレットのみを移動し、単語や段落を自動選択しません。ドラッグ選択には影響しません。"},
        ...
        {"validation.difficulty_level_missing", "[ERROR] 難易度が入力されていません"},
        {"validation.difficulty_level_missing_type", "難易度未入力"},
        ...
        {"video_export.export_range_from_selection", "選択範囲を出力"},
        {"video_export.export_selection_invalid", "選択した譜面オブジェクトから有効な出力範囲を作成できません。"},
        {"video_export.export_selection_changed", "選択範囲を開く前に譜面が変更されました。もう一度選択してください。"},
        ...
        {"track_metadata.background_video_exists_overwrite", "この譜面には既に背景動画があります。置き換えますか？元のファイルはバックアップとして保存されます。"},
        {"track_metadata.copying_background_image", "背景画像をコピーしています..."},
        {"track_metadata.copying_background_video", "背景動画をコピーしています..."},
        {"track_metadata.extract_cover_to_bg_jpg", "カバーを bg.jpg に抽出"},
        {"track_metadata.failed_to_import_media", "メディアファイルの読み込みに失敗しました。\n\n詳細: %1"},
        {"track_metadata.failed_to_read_image", "選択したファイルを画像として読み取れませんでした。"},
        ...
        {"track_metadata.import_background_video", "背景動画を読み込む"},
        {"track_metadata.imported_background_image", "背景画像を %1 に読み込みました。"},
        {"track_metadata.imported_background_video", "背景動画を %1 に読み込みました。"},
        {"track_metadata.imported_with_cleanup_warning", "新しいメディアを読み込みましたが、次のファイルのバックアップを保存できませんでした:\n%1"},
        ...
        {"track_metadata.unsupported_media_file", "選択したファイル形式はサポートされていません。"},
        ...
        {"media_tools.compress_1_under_20_mib", "%1 を 20 MB 未満に圧縮して音声トラックを削除し、バックアップ %2 を作成/上書きします。続行しますか？"},
        {"media_tools.compress_the_background_video_under", "20 MB 未満に圧縮します。"},
        {"media_tools.compress_video", "動画圧縮"},
        {"media_tools.compressed_1_under_20_mib", "%1 を 20 MB 未満に圧縮しました。"},
        {"media_tools.compressed_1_under_20_mib_2", "%1 を 20 MB 未満に圧縮しました（元ファイルは %2 にバックアップ）。"},
        {"media_tools.compressing_video", "動画を圧縮中..."},
        {"media_tools.convert_track_mp3_to_44100", "%1 を 44100Hz に変換し、バックアップ %2 を作成/上書きします。続行しますか？"},
        {"media_tools.converted_track_mp3_to_44100", "%1 を 44100Hz に変換しました。"},
        {"media_tools.converted_track_mp3_to_44100_2", "%1 を 44100Hz に変換しました（元ファイルは %2 にバックアップ）。"},
        ...
        {"media_tools.insert_a_black_screen_at", "動画の先頭に黒画面を追加します。"},
        {"media_tools.insert_silence_at_the_start", "音声の先頭に無音を追加します。"},
        ...
        {"media_tools.processing_track_mp3", "%1 を処理中..."},
        {"media_tools.restore_backup", "バックアップを復元"},
        {"media_tools.sample_rate", "サンプルレート変換"},
        {"media_tools.sample_rate_description", "形式を維持して 44100 Hz に変換します。"},
        ...
        {"media_tools.supported_track_audio", "対応音声（track.mp3/track.wav/track.flac/track.ogg）"},
        {"media_tools.track_mp3_failed", "%1 の処理に失敗しました"},
        {"media_tools.track_mp3_processing_canceled", "%1 の処理をキャンセルしました。"},
        {"media_tools.track_mp3_was_not_found", "現在の譜面フォルダーに対応音声（track.mp3/track.wav/track.flac/track.ogg）がありません。"},
        ...
        {"net.upload_detail_url_1", "URL: %1"},
        {"net.upload_failure_details_available", "Expand Details to view and copy the complete failure diagnostics."},
        {"net.upload_log_open_failed_1", "アップロードログを書き込めません：%1"},
        {"net.upload_log_saved_1", "アップロードログ：%1"},
        {"net.upload_failed_count_1", "%1 chart(s) failed to upload."},
        {"net.upload_not_uploaded_batch_stopped", "Not uploaded (batch stopped)"},
        {"net.upload_payload_too_large", "Upload content is too large (HTTP 413); compress or remove the video"},
        {"net.upload_rate_limit_retry_exhausted", "Rate limit remained after one delayed retry"},
