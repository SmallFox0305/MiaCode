...
public:
    explicit PreviewModel(miacode::ShellNotifications& notifications,
...
private:
    ...
    miacode::PreviewSurface** surfaceSlot_ = nullptr;
    miacode::PreviewSurface* surface() const
    {
    ...
    miacode::PlaybackControl** controlSlot_ = nullptr;
