...
int main(int argc, char** argv)
{
    ...
    const QString page = readSource(QStringLiteral("src/app/ui/export/CoverExportPage.qml"));
    const QString sessionHeader = readSource(
        QStringLiteral("src/app/ui/export/CoverExportSession.h"));
    ...
    expect(pageHost.contains(QStringLiteral("coverWindowRequested"))
               ...
               && bootstrap.contains(QStringLiteral("new CoverExportWindow"))
    ...
    const int seedStart = session.indexOf(
        QStringLiteral("void CoverExportSession::seedFromDifficulty(int difficultyId)"));
    ...
    const int applyStart = session.indexOf(
        QStringLiteral("bool CoverExportSession::applyCompositionJsonInternal(const QJsonObject& root,"));
    ...
    const int applyWrapperStart = session.indexOf(
        QStringLiteral("bool CoverExportSession::applyCompositionJson(const QJsonObject& root, bool reportErrors)"));
    ...
    const int renderStart = session.indexOf(
        QStringLiteral("bool CoverExportSession::renderChartFrame("));
    ...
    const int bindFacade = session.indexOf(
        QStringLiteral("void CoverExportSession::bindLiveChartScene(QObject* scene)"));
