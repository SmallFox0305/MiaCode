...
bool verifySingleOwnerRevisionAndSavePoint(QTextStream& out)
{
    ...
    QObject::connect(&workspace, &miacode::ChartWorkspace::changed,
...
{
    using miacode::ChartWorkspaceDifficultyField;
    using miacode::ChartWorkspaceDocumentField;
...
bool verifyUnifyLeavesUntouchedSlotsAlone(QTextStream& out)
{
    ...
    workspace.updateDocumentField(
        miacode::ChartWorkspaceDocumentField::Designer, QStringLiteral("solo"));
...
bool verifyDifficultyDiscardRestoresChartBody(QTextStream& out)
{
    ...
    miacode::ChartWorkspace metadataWorkspace;
    metadataWorkspace.openSource(sourceWithTwoDifficulties());
    metadataWorkspace.updateDocumentField(
        miacode::ChartWorkspaceDocumentField::Title, QStringLiteral("changed"));
